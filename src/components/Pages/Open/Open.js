        ...
        >
          <div className="container d-flex align-items-center">
            <h1 className="logo me-auto">
              ...
              {/* <img className="bizhublogo" src={bizhub} alt="" /> */}
            </h1>
            {/* <div className="logooo">
              <img src={bizhub} alt="Your Logo" className="logooo-image" />
            </div> */}
            ...
            <div className="row">
              ...
              >
                ...
                <div className="exp">
                  ...
                  <br />
                  <button className="viewmoree" href="#services">
                    View More
                  </button>
                </div>
            ...
            <div className="container" data-aos="fade-up">
              ...
              >
                <div className="sitecard">
                  ...
                  <div className="content">
                    <p className="desc">
                      Cars Valley, the blockchain-based solution for buying and
                      selling secondhand cars. With blockchain technology, we
                      provide enhanced security, transparency, and trust for our
                      users.
                    </p>
                    <a
                ...
                <div className=" sitecard">
                  ...
                  <div className="content">
                    <p className="desc">
                      Verified Careers: Your gateway to trusted job
                      opportunities. Say goodbye to fake jobs and hello to
                      verified employment. Join the revolution for a future of
                      trust and success. Get hired with certainty, only on
                      "Verified Careers.
                    </p>
                    <a
                      style={{ position: "relative", top: "10px" }}
                ...
                <div className=" sitecard">
                  ...
                  <div className="content">
                    <p className="desc">
                      It provides a centralized hub for buying and selling
                      bikes, accessing bike-related information, connecting with
                      local biking communities, and exploring biking events and
                      trails.
                    </p>
                    <a
